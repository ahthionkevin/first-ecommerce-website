...
<body>
    ...
    {     
        ...
        if(!is_integer($age))
              echo "<font color=\"red\">VEUILLEZ SAISIR UN ENTIER POUR L'AGE</font>";
        if (is_integer($age) && $age > 100)
               echo "<font color=\"blue\">On est pas des tortues :O </font>";
        if (is_integer($age) && $age < 18)
                echo "<font color=\"green\">Svp appeler votre parent ou responsable pour vous faire cette inscription car vous n'etes pas encore adulte </font>";

      if(is_integer($age)&& (18<$age||$age==18) && $age <100)
        
         { $sql="INSERT INTO client (nom,prenom,adresse,mail,age,ville) VALUES(\"$nom\",\"$prenom\",\"$adresse\",\"$mail\",\"$age\",\"$ville\")";
        ...
        if($result)
        {
            ...
            echo "<script>alert(\"VOS DONNEES ONT ETE AJOUTE AVEC SUCCES\");/*window.location(\"loginView.php\")*/</script>";
        }
    ...
    <form action="signInView.php" method="post" class="read" autocomplete="off">
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="age" class="sign"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="ville" class="sign"></td>
            </tr>
