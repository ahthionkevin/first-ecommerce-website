    ...
    <?php
        if(isset($_SESSION['panier']) && !empty($_SESSION['panier']))
        {
            ...
            else
            {
                ...
                echo "<tr>
                <td><img height=\"100px\" src=\"../tp1_2/public/$coord[0].jpg\"/></td>
                <td>$coord[1]</td>
                <td>$coord[2] dhs</td>
                <td>$coord[3]</td>
                <td>" . $_SESSION['panier'][$coord[0]] . "</td>
                <td> " . $_SESSION['panier'][$coord[0]]*$coord[2] . " dhs </td>
                <td><a href=\"panier.php?del=$coord[0]\">Supprimer</a></td>
                </tr>";

                $total=$_SESSION['panier'][$coord[0]]*$coord[2];
                while($coord=mysqli_fetch_row($result))
                {
                    
                    echo "<tr>
                    <td><img height=\"100px\" src=\"../tp1_2/public/$coord[0]\"/></td>
                    <td>$coord[1]</td>
                    <td>$coord[2] dhs</td>
                    <td>$coord[4]</td>
                    <td>" . $_SESSION['panier'][$coord[0]] . "</td>
