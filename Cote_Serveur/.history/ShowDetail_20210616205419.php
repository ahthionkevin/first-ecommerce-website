...
<?php
    ...
    if(isset($_GET['idProduct']) && !empty($_GET['idProduct']))
    {
        ...
        echo "<form action=\"addCommand.php\" method=\"post\"><label>Prix: </label><input id=\"prev\" type=\"button\" value=\"-\"><input type=\"text\" name=\"qte\" value=\"0\"><input id=\"next\" type=\"button\" value=\"+\"></form>";
        echo "</div>";
