...
<?php
    ...
    if(isset($_GET['idProduct']) && !empty($_GET['idProduct']))
    {
        ...
        echo "<form action=\"updateUser.php?idProduct=$coord[0]\" method=\"post\" class=\"read\">
        <table>
            <tr>
