...
if(isset($_POST['nom']) && isset($_POST['designation']) && isset($_POST['prix']) && isset($_POST['categorie']) && isset($_POST['img']) && !empty($_POST['nom']) && !empty($_POST['designation']) && !empty($_POST['prix']) && !empty($_POST['categorie']) && !empty($_POST['img']) )
{     
    $nom=$_POST['nom'];
